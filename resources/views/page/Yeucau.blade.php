...
<div class="registration-form">
    <form method="post" action="{{route('mail')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <center><input class="form-control item" type="text" name="lop" pattern="[a-Z]" placeholder="Lớp  - phòng học...." required></center>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <center><button onclick="myFunction()" class="btn btn-primary btn-block create-account" type="submit" style="width: 30%">Submit</button></center>
        </div>
    </form>
    <script>
        function myFunction() {
